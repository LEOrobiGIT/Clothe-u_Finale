...
<html>
    <head>
        ...
        <!-- Stile  -->
        <link rel="stylesheet" href="../Clothe-u_Finale/css/styleFinale.css">
    ...
    <body>
        ...
        <input type="checkbox" name="" id="toggler">
            ...
            <div class="icons">
                ...
                <a href="carrello.html" class="fas fa-shopping-cart"></a>
                <a href="accesso_clothe.html" class="fas fa-user"></a>
            </div>
            </nav>
